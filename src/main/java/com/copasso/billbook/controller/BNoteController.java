...
public class BNoteController {
    ...
    @ResponseBody
    public NoteListBean userNoteinfo(@PathVariable("id") String id) {
    ...
    @ResponseBody
    public List<BSort> sortinfo(@PathVariable("id") String id) {
    ...
    @ResponseBody
    public BSort2 addSort(@Param("uid") String uid, @Param("sortName") String sortName,
    ...
    @ResponseBody
    public BSort2 updateSort(@Param("id") Integer id, @Param("uid") String uid, @Param("sortName") String sortName,
                             @Param("sortImg") String sortImg, @Param("income") Boolean income) {
    ...
    @ResponseBody
    public List<BPay> deletePay(@PathVariable("id") String id) {
    ...
    @ResponseBody
    public List<BPay> payinfo(@PathVariable("id") String id) {
        return bPayService.findPayinfoByUserId(id);
    }
    ...
    @ResponseBody
    public BPay2 addPay(@Param("uid") String uid, @Param("payName") String payName,
    ...
    @ResponseBody
    public BPay2 addPay(@Param("id") Integer id, @Param("uid") String uid, @Param("payName") String payName,
                        @Param("payImg") String payImg, @Param("payNum") String payNum) {
