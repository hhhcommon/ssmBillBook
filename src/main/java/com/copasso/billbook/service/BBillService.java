...
public class BBillService {
     ...
     * @return
     */
    public List<BBill> findBillsByUserId(String userid) {
     ...
     * @return
     */
    public List<BBill> findBillsByUserIdWithYearMouthDay(String userid, String date) {
     ...
     * @return
     */
    public List<BBill> findChatsByUserIdWithYSortYM(String userid, Integer sortid, String date, boolean income) {
        if (income)
     ...
     * @return
     */
    public String getTotalIncomeByUserIdWithYearMonth(String userid, String date) {
        return StringUtils.null2Zero(bBillMapper.getTotalIncomeByUserIdWithYearMonth(userid, date));
    }

    public String getTotalOutcomeByUserIdWithYearMonth(String userid, String date) {
     ...
     * @return
     */
    public String getTotalIncomeByUserIdAndSortIdYM(String userid, Integer sortid, String date) {
        return StringUtils.null2Zero(bBillMapper.getTotalIncomeByUserIdWithSortIdYM(userid, sortid, date));
    }

    public String getTotalOutcomeByUserIdAndSortIdYM(String userid, Integer sortid, String date) {
     ...
     * @return
     */
    public String getTotalIncomeByUserIdWithPayIdYM(String userid, Integer sortid, String date) {
        return StringUtils.null2Zero(bBillMapper.getTotalIncomeByUserIdWithPayIdYM(userid, sortid, date));
    }

    public String getTotalOutcomeByUserIdWithPayIdYM(String userid, Integer sortid, String date) {
     ...
     * @return
     */
    public String getTotalIncomeByUserIdWithYearMonthDay(String userid, String date) {
        return StringUtils.null2Zero(bBillMapper.getTotalIncomeByUserIdWithYearMonthDay(userid, date));
    }

    public String getTotalOutcomeByUserIdWithYearMonthDay(String userid, String date) {
